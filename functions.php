...
add_action('init', 'hedomi_rental_init');
function hedomi_rental_init(){
	...
	register_taxonomy('rental-type',
		...
		array(
			...
			'labels' => array(
				...
				'popular_items' => 'тип недвижимости',
				'all_items' => 'Все типы недвижимости',
				'parent_item' => null,
				'parent_item_colon' => null,
				'edit_item' => 'Редактировать тип недвижимости', 
				'update_item' => 'Обновить данные',
				'new_item_name' => 'тип недвижимости',
				'separate_items_with_commas' => 'разделить запятой',
